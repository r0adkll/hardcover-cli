...
#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/author_by_id.graphql", response_derives = "Debug, Clone")]
pub struct AuthorById;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/series_by_id.graphql", response_derives = "Debug, Clone")]
pub struct SeriesById;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/edition_by_id.graphql", response_derives = "Debug, Clone")]
pub struct EditionById;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/list_by_id.graphql", response_derives = "Debug, Clone")]
pub struct ListById;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/prompt_by_id.graphql", response_derives = "Debug, Clone")]
pub struct PromptById;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/user_by_username.graphql", response_derives = "Debug, Clone")]
pub struct UserByUsername;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/author_id_by_slug.graphql", response_derives = "Debug, Clone")]
pub struct AuthorIdBySlug;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/series_id_by_slug.graphql", response_derives = "Debug, Clone")]
pub struct SeriesIdBySlug;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/list_id_by_slug.graphql", response_derives = "Debug, Clone")]
pub struct ListIdBySlug;

#[derive(GraphQLQuery)]
#[graphql(schema_path = "schema.json", query_path = "queries/prompt_id_by_slug.graphql", response_derives = "Debug, Clone")]
